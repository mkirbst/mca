...
Der verwendete PCA9685 ist ein programmierbar PWM-Controller mit 16 Kanälen und einer Auflösung von 12 Bit. Angesteuert wird dieser Controller über das Bus-Protokoll I2C. Durch sechs vorhandene Adresspins können bis zu 62 PCA9685 an einem Bus betrieben werden. Des Weiteren ist es möglich alle am Bus befindlichen Controller gleichzeitig über eine All-Call-Adresse anzusprechen sowie zu konfigurieren. Zusätzlich können mittels 3 verschiedener Sub-Call-Adressen auch verschiedene Gruppen von PWM-Controllern definiert werden. Über einen separaten OE-Eingang ist es möglich die Ausgabe der PWM-Kanäle komplett an- und abzuschalten.
...
im Versuchsaufbau präzise Messwerte liefern und als Bezugspunkt für die anderen Lichtsensoren dienen. Die Messwerte des Mini-Lux werden von Hand in den
...
einer Länge von 120 cm und einem Durchmesser von 10 cm benutzt. Dieses Rohr
...
\begin{figure}[h] 
  ...
  \subfigure[Deckel mit Messsensoren bestückt.]{\includegraphics[width=0.495\textwidth]{./images/foto_hardware_sensordeckel.png}} 
  \subfigure[Messrohr]{\includegraphics[width=1\hsize]{./images/foto_hardware_messrohr.png}}
  \caption[Messaufbau]{\label{fotohwmessaufbau}Messaufbau, Quelle: Autor}
\end{figure} 

%\begin{figure}[h]
%\begin{center}
%  \includegraphics[width=1\hsize]{./images/foto_hardware_messrohr.png}
%\end{center}
%\caption[Messaufbau: Papprohr mit LED-Modul und Sensoren bestückt, Quelle:
%Autor]{\label{fotohwmessrohr}Messaufbau: Papprohr mit LED-Modul und Sensoren bestückt, Quelle:
%Autor}
%\end{figure}


Die drei eingesetzten Messsensoren bestehen aus einem Helligkeitssensoren GeoSys GSLx, einem Taos TSL2561 sowie als Referenzmessgerät ein kalibriertes Luxmeter
Minilux der Firma MX-Electronic \cite{specminilux}.  
