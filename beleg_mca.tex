...
%%    \includegraphics[width=1\hsize]{./images/foto_hardware_komplett.png}
  ...
  \end{center}
\caption[C\"Ubersicht der eingesetzten Hardware, Quelle: Autoren]{\label{fotohwuebersicht}\"Ubersicht der eingesetzten Hardware (v.l.n.r): Prototyp Straßenleuchte, LED-Control-Board, Sockel-Adapter, Mikrocontroller LPC1768, LED-Modul 350mA, LED-Modul 500mA, Optik Titanium-O-SS, Optik Titanium-O-M.}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\hsize]{./images/osziGeosys.png}
\end{center}
